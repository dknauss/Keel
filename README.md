...
**The colour-coded environment indicator in the admin bar is the same idea.** Knowing which site you are on before you take consequential actions doesn't require a loud or invasive waring notice. It is one of the opt-in defaults rather than part of the baseline, and worth turning on anywhere production and staging are open in adjacent tabs.
